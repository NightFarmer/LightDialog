package com.nightfarmer.lightdialog.picker.lib;
...
import com.nightfarmer.lightdialog.picker.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //单位的Label
        if (label != null) {
            float textSize = paintCenterText.getTextSize();
