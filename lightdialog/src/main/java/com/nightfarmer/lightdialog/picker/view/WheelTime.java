package com.nightfarmer.lightdialog.picker.view;

import android.content.Context;
import android.view.View;

import com.nightfarmer.lightdialog.R;
import com.nightfarmer.lightdialog.common.listener.OnItemSelectedListener;
import com.nightfarmer.lightdialog.picker.adapter.NumericWheelAdapter;
import com.nightfarmer.lightdialog.picker.lib.WheelView;
...
import com.nightfarmer.lightdialog.picker.TimePickerView.Type;
...
public class WheelTime {
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        line_year = view.findViewById(R.id.line_year);
        line_month = view.findViewById(R.id.line_month);
        line_day = view.findViewById(R.id.line_day);
        line_hours = view.findViewById(R.id.line_hour);
        ...
        switch (type) {
            case ALL:
                ...
                line_hours.setVisibility(View.VISIBLE);
                break;
            case YEAR_MONTH_DAY:
                textSize = textSize * 3.5f;
                wv_hours.setVisibility(View.GONE);
                wv_mins.setVisibility(View.GONE);
                line_year.setVisibility(View.VISIBLE);
                line_month.setVisibility(View.VISIBLE);
                line_day.setVisibility(View.GONE);
                line_hours.setVisibility(View.GONE);
                break;
            case HOURS_MINS:
                textSize = textSize * 4;
