 ...
 */
public class AlertActivity extends AppCompatActivity implements OnItemClickListener, OnDismissListener {
    ...
    public void alertShow2(View view) {
        new AlertView("提示", "确定要毁灭地球？", null, new String[]{"确定"}, null, this, AlertView.Style.Alert, this).show();
    }
